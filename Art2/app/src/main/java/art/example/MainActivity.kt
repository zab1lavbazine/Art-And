...
fun MyApp() {
    ...
    NavHost(navController, startDestination = Screen.Login.route) {
        ...
        composable(Screen.PostDetail.route, arguments = listOf(navArgument("postId") { type = NavType.LongType })
        ) { backStackEntry ->
        ...
        composable(Screen.FolderDetail.route, arguments = listOf(navArgument("folderId") { type = NavType.LongType })
        ){
            navBackStackEntry ->
